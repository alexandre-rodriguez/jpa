...
public class StoredProceduresTest extends EntityManagerTest {
    ...
    public void chamarNamedStoredProcedure() {
        StoredProcedureQuery storedProcedureQuery = entityManager.createNamedStoredProcedureQuery("cliente.compraram_acima_media");
    ...
    @Test
    public void usarPrecoProdutoExercio() {
