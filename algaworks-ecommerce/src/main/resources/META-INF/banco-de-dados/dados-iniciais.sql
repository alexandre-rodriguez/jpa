-- Alterado / removido: now, data_sub, xml da nota fiscal,
...
insert into cliente (id, versao, nome, cpf) values (1, 0, 'Fernando Medeiros', '111.111.111-11');
insert into cliente (id, versao, nome, cpf) values (2, 0, 'Marcos Mariano', '222.222.222-22');
insert into cliente (id, versao, nome, cpf) values (101, 0, 'José da Silva', '333.333.333-33');
...
insert into cliente_detalhe(cliente_id, sexo, data_nascimento) values (101, 'MASCULINO', (now() - interval '45 year'));
